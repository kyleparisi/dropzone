...
var _templateObject = _taggedTemplateLiteral(['<button>Add files</button>'], ['<button>Add files</button>']),
    _templateObject2 = _taggedTemplateLiteral(['<input type="file" style="display: none" onchange=', ' name="files[]" multiple />'], ['<input type="file" style="display: none" onchange=', ' name="files[]" multiple />']),
    _templateObject3 = _taggedTemplateLiteral(['<div style="font-size: 3rem;padding: 1rem;"></div>'], ['<div style="font-size: 3rem;padding: 1rem;"></div>']),
    _templateObject4 = _taggedTemplateLiteral(['<li>Drag and drop your files here</li>'], ['<li>Drag and drop your files here</li>']),
    _templateObject5 = _taggedTemplateLiteral(['\n            <li>\n                <div style="cursor: pointer;" data-index="', '" data-name="close" onclick=', '>x</div>\n                ', '\n                <div>', '</div>\n            </li>'], ['\n            <li>\n                <div style="cursor: pointer;" data-index="', '" data-name="close" onclick=', '>x</div>\n                ', '\n                <div>', '</div>\n            </li>']),
    _templateObject6 = _taggedTemplateLiteral(['\n        <div ondragover=', ' ondragleave=', ' ondrop=', ' class="', '">\n            <ul>\n                ', '\n            </ul>\n        </div>'], ['\n        <div ondragover=', ' ondragleave=', ' ondrop=', ' class="', '">\n            <ul>\n                ', '\n            </ul>\n        </div>']),
    _templateObject7 = _taggedTemplateLiteral(['', ''], ['', '']),
    _templateObject8 = _taggedTemplateLiteral(['<div onclick=', ' class="', '">', '</div>'], ['<div onclick=', ' class="', '">', '</div>']);
...
var Dropzone = function () {
    ...
    function Dropzone() {
        ...
        this.state = {
            ...
            buttonElement: config.buttonElement || yo(_templateObject),
            classes: {},
        ...
        this.input = yo(_templateObject2, this.onchange.bind(this));

        // Attach click event to buttonElement
        this.state.buttonElement.onclick = function () {
    ...
    _createClass(Dropzone, [{
        ...
        value: function renderFiles() {
            ...
            return this.state.files.map(function (file, index) {
                ...
                var fileName = file.name.replace(/[^a-zA-Z0-9.]/ig, '_');
                if (_this2.state.fileNameLength && fileName.length > _this2.state.fileNameLength) {
                    var trimmedName = fileName.substring(0, _this2.state.fileNameLength);
                ...
                return yo(_templateObject5, index, _this2.removeAttachedFile.bind(_this2), _this2.state.fileIcon(file), fileName);
            });
        }
        ...
        key: 'dropzoneComponent',
        value: function dropzoneComponent() {
            ...
            return yo(_templateObject6, this.dragover.bind(this), this.dragleave.bind(this), this.drop.bind(this), classes, this.state.files.length ? this.renderFiles() : this.renderInstructions());
        }
        ...
        key: 'buttonComponent',
        value: function buttonComponent() {
            return yo(_templateObject7, this.state.buttonElement);
        }
        ...
        value: function feedbackComponent() {
            return yo(_templateObject8, this.input.click, this.state.classes.feedback, this.state.feedback);
        }
    }]);
...
},{"microevent":8,"yo-yo":11}],2:[function(require,module,exports){
...
},{"./update-events.js":12,"bel":2,"morphdom":9}],12:[function(require,module,exports){
module.exports = [
